      ...
      <div>
        ...
        <style jsx>{`
          ...
          .content-container {
            ...
            width: 100%;
            margin: 0 auto;
            padding: 50px 0 0 0; /* Agrega margen superior para evitar que el contador tape el contenido */
        ...
        <div className="content-container">
          ...
          <div className="title-section">
            <h1>
              ...
              <br />
              <span className="default-text">+ BONOS DE REGALO</span>
              <br />
              <span className="default-text">
                            solo por <span style={{ color: "#28a745" }}>$9.99 USD!</span>
                        </span>
            </h1>
          </div>
